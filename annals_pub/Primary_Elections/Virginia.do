...
Republican primary in Virginia by county, and creates a small 
data file with counties (nonclustered) as cases and the following variables:
1) String variable with county name
2) String variable with "Virginia" to indicate state
...
Virginia elections commission website and converted into .xlsx format. 
*/
...
import excel using VA_2016_Primary.xlsx, ///
   cellrange(A3:R135) 
...
save VA_2016_Primary.dta, replace
clear
